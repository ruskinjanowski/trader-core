...
public class LunoAPIImpl implements LunoAPI {
	...
	private static final Set<String> VALID_TYPES = new HashSet<String>(
			Arrays.asList("ZAR_EFT", "NAD_EFT", "KES_MPESA", "MYR_IBG", "IDR_LLG"));
	...
	public LunoPostOrder postLimitOrder(String pair, OrderType type, BigDecimal volume, BigDecimal price,
		...
		return luno.postLimitOrder(this.auth, pair, type, volume, price, baseAccountId, counterAccountId, true);
	}

	@Override
	public LunoPostOrder postMarketOrder(String pair, OrderType type, BigDecimal counterVolume, BigDecimal baseVolume,
			String baseAccountId, String counterAccountId) throws IOException, LunoException {
	...
	@Override
	public org.knowm.xchange.luno.dto.trade.LunoUserTrades listTrades(String pair, Long since, Integer limit)
	...
	@Override
	public LunoBoolean send(BigDecimal amount, String currency, String address, String description, String message)
			throws IOException, LunoException {
